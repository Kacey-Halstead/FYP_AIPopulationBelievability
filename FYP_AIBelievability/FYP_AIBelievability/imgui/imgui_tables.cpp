...
ImGuiTable* ImGui_Implementation::TableFindByID(ImGuiID id)
{
...
bool    ImGui_Implementation::BeginTable(const char* str_id, int columns_count, ImGuiTableFlags flags, const ImVec2& outer_size, float inner_width)
{
    ImGuiID id = GetID(str_id);
    return BeginTableEx(str_id, id, columns_count, flags, outer_size, inner_width);
}

bool    ImGui_Implementation::BeginTableEx(const char* name, ImGuiID id, int columns_count, ImGuiTableFlags flags, const ImVec2& outer_size, float inner_width)
{
    ImGuiContext& g = *GImGui;
...
void ImGui_Implementation::TableBeginInitMemory(ImGuiTable* table, int columns_count)
{
...
// Apply queued resizing/reordering/hiding requests
void ImGui_Implementation::TableBeginApplyRequests(ImGuiTable* table)
{
...
static void TableSetupColumnFlags(ImGuiTable* table, ImGuiTableColumn* column, ImGuiTableColumnFlags flags_in)
{
    ...
    if (table->Flags & ImGuiTableFlags_Sortable)
    {
        ...
        ImGui_Implementation::TableFixColumnSortDirection(table, column);
    }
}
...
void ImGui_Implementation::TableUpdateLayout(ImGuiTable* table)
{
    ImGuiContext& g = *GImGui;
...
void ImGui_Implementation::TableUpdateBorders(ImGuiTable* table)
{
    ImGuiContext& g = *GImGui;
...
void    ImGui_Implementation::EndTable()
{
    ImGuiContext& g = *GImGui;
...
void ImGui_Implementation::TableSetupColumn(const char* label, ImGuiTableColumnFlags flags, float init_width_or_weight, ImGuiID user_id)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
// [Public]
void ImGui_Implementation::TableSetupScrollFreeze(int columns, int rows)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    IM_ASSERT(table != NULL && "Need to call TableSetupColumn() after BeginTable()!");
...
int ImGui_Implementation::TableGetColumnCount()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
const char* ImGui_Implementation::TableGetColumnName(int column_n)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    if (!table)
...
const char* ImGui_Implementation::TableGetColumnName(const ImGuiTable* table, int column_n)
{
...
void ImGui_Implementation::TableSetColumnEnabled(int column_n, bool enabled)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
ImGuiTableColumnFlags ImGui_Implementation::TableGetColumnFlags(int column_n)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    if (!table)
...
ImRect ImGui_Implementation::TableGetCellBgRect(const ImGuiTable* table, int column_n)
{
    const ImGuiTableColumn* column = &table->Columns[column_n];
...
ImGuiID ImGui_Implementation::TableGetColumnResizeID(ImGuiTable* table, int column_n, int instance_no)
{
    IM_ASSERT(column_n >= 0 && column_n < table->ColumnsCount);
...
int ImGui_Implementation::TableGetHoveredColumn()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    if (!table)
...
int ImGui_Implementation::TableGetHoveredRow()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    if (!table)
...
void ImGui_Implementation::TableSetBgColor(ImGuiTableBgTarget target, ImU32 color, int column_n)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
int ImGui_Implementation::TableGetRowIndex()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    if (!table)
...
void ImGui_Implementation::TableNextRow(ImGuiTableRowFlags row_flags, float row_min_height)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
void ImGui_Implementation::TableBeginRow(ImGuiTable* table)
{
...
void ImGui_Implementation::TableEndRow(ImGuiTable* table)
{
    ImGuiContext& g = *GImGui;
...
int ImGui_Implementation::TableGetColumnIndex()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    if (!table)
...
bool ImGui_Implementation::TableSetColumnIndex(int column_n)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    if (!table)
...
bool ImGui_Implementation::TableNextColumn()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    if (!table)
...
void ImGui_Implementation::TableBeginCell(ImGuiTable* table, int column_n)
{
    ImGuiContext& g = *GImGui;
    ImGuiTableColumn* column = &table->Columns[column_n];
    ImGuiWindow* window = table->InnerWindow;
...
void ImGui_Implementation::TableEndCell(ImGuiTable* table)
{
...
float ImGui_Implementation::TableCalcMaxColumnWidth(const ImGuiTable* table, int column_n)
{
    const ImGuiTableColumn* column = &table->Columns[column_n];
...
float ImGui_Implementation::TableGetColumnWidthAuto(ImGuiTable* table, ImGuiTableColumn* column)
{
...
void ImGui_Implementation::TableSetColumnWidth(int column_n, float width)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
void ImGui_Implementation::TableSetColumnWidthAutoSingle(ImGuiTable* table, int column_n)
{
...
void ImGui_Implementation::TableSetColumnWidthAutoAll(ImGuiTable* table)
{
    for (int column_n = 0; column_n < table->ColumnsCount; column_n++)
    {
        ImGuiTableColumn* column = &table->Columns[column_n];
...
void ImGui_Implementation::TableUpdateColumnsWeightFromWidth(ImGuiTable* table)
{
...
void ImGui_Implementation::TablePushBackgroundChannel()
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    ImGuiTable* table = g.CurrentTable;
...
void ImGui_Implementation::TablePopBackgroundChannel()
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    ImGuiTable* table = g.CurrentTable;
...
void ImGui_Implementation::TableSetupDrawChannels(ImGuiTable* table)
{
...
void ImGui_Implementation::TableMergeDrawChannels(ImGuiTable* table)
{
    ImGuiContext& g = *GImGui;
    ImDrawListSplitter* splitter = table->DrawSplitter;
...
static ImU32 TableGetColumnBorderCol(ImGuiTable* table, int order_n, int column_n)
{
    ...
    if (is_resized || is_hovered)
        return ImGui_Implementation::GetColorU32(is_resized ? ImGuiCol_SeparatorActive : ImGuiCol_SeparatorHovered);
...
void ImGui_Implementation::TableDrawBorders(ImGuiTable* table)
{
    ImGuiWindow* inner_window = table->InnerWindow;
...
ImGuiTableSortSpecs* ImGui_Implementation::TableGetSortSpecs()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    IM_ASSERT(table != NULL);
...
void ImGui_Implementation::TableFixColumnSortDirection(ImGuiTable* table, ImGuiTableColumn* column)
{
...
ImGuiSortDirection ImGui_Implementation::TableGetColumnNextSortDirection(ImGuiTableColumn* column)
{
...
void ImGui_Implementation::TableSetColumnSortDirection(int column_n, ImGuiSortDirection sort_direction, bool append_to_sort_specs)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
void ImGui_Implementation::TableSortSpecsSanitize(ImGuiTable* table)
{
...
void ImGui_Implementation::TableSortSpecsBuild(ImGuiTable* table)
{
...
float ImGui_Implementation::TableGetHeaderRowHeight()
{
...
float ImGui_Implementation::TableGetHeaderAngledMaxLabelWidth()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    float width = 0.0f;
...
void ImGui_Implementation::TableHeadersRow()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    ...
    ImVec2 mouse_pos = ImGui_Implementation::GetMousePos();
...
void ImGui_Implementation::TableHeader(const char* label)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    if (window->SkipItems)
...
void ImGui_Implementation::TableAngledHeadersRow()
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    ImGuiTableTempData* temp_data = table->TempData;
...
void ImGui_Implementation::TableAngledHeadersRowEx(ImGuiID row_id, float angle, float max_label_width, const ImGuiTableHeaderData* data, int data_count)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    ImGuiWindow* window = g.CurrentWindow;
...
void ImGui_Implementation::TableOpenContextMenu(int column_n)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
...
bool ImGui_Implementation::TableBeginContextMenuPopup(ImGuiTable* table)
{
...
void ImGui_Implementation::TableDrawDefaultContextMenu(ImGuiTable* table, ImGuiTableFlags flags_for_section_to_display)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    if (window->SkipItems)
...
ImGuiTableSettings* ImGui_Implementation::TableSettingsCreate(ImGuiID id, int columns_count)
{
    ImGuiContext& g = *GImGui;
...
ImGuiTableSettings* ImGui_Implementation::TableSettingsFindByID(ImGuiID id)
{
...
ImGuiTableSettings* ImGui_Implementation::TableGetBoundSettings(ImGuiTable* table)
{
...
void ImGui_Implementation::TableResetSettings(ImGuiTable* table)
{
...
void ImGui_Implementation::TableSaveSettings(ImGuiTable* table)
{
...
void ImGui_Implementation::TableLoadSettings(ImGuiTable* table)
{
    ImGuiContext& g = *GImGui;
...
static void* TableSettingsHandler_ReadOpen(ImGuiContext*, ImGuiSettingsHandler*, const char* name)
{
    ...
    if (ImGuiTableSettings* settings = ImGui_Implementation::TableSettingsFindByID(id))
    {
    ...
    return ImGui_Implementation::TableSettingsCreate(id, columns_count);
}
...
void ImGui_Implementation::TableSettingsAddSettingsHandler()
{
...
void ImGui_Implementation::TableRemove(ImGuiTable* table)
{
...
void ImGui_Implementation::TableGcCompactTransientBuffers(ImGuiTable* table)
{
...
void ImGui_Implementation::TableGcCompactTransientBuffers(ImGuiTableTempData* temp_data)
{
...
void ImGui_Implementation::TableGcCompactSettings()
{
    ImGuiContext& g = *GImGui;
...
void ImGui_Implementation::DebugNodeTable(ImGuiTable* table)
{
    ImGuiContext& g = *GImGui;
...
void ImGui_Implementation::DebugNodeTableSettings(ImGuiTableSettings* settings)
{
...
void ImGui_Implementation::SetWindowClipRectBeforeSetChannel(ImGuiWindow* window, const ImRect& clip_rect)
{
...
int ImGui_Implementation::GetColumnIndex()
{
    ImGuiWindow* window = GetCurrentWindowRead();
    return window->DC.CurrentColumns ? window->DC.CurrentColumns->Current : 0;
}

int ImGui_Implementation::GetColumnsCount()
{
    ImGuiWindow* window = GetCurrentWindowRead();
    return window->DC.CurrentColumns ? window->DC.CurrentColumns->Count : 1;
}

float ImGui_Implementation::GetColumnOffsetFromNorm(const ImGuiOldColumns* columns, float offset_norm)
{
    return offset_norm * (columns->OffMaxX - columns->OffMinX);
}

float ImGui_Implementation::GetColumnNormFromOffset(const ImGuiOldColumns* columns, float offset)
{
...
static float GetDraggedColumnOffset(ImGuiOldColumns* columns, int column_index)
{
    ...
    x = ImMax(x, ImGui_Implementation::GetColumnOffset(column_index - 1) + g.Style.ColumnsMinSpacing);
    if ((columns->Flags & ImGuiOldColumnFlags_NoPreserveWidths))
        x = ImMin(x, ImGui_Implementation::GetColumnOffset(column_index + 1) - g.Style.ColumnsMinSpacing);

    return x;
}

float ImGui_Implementation::GetColumnOffset(int column_index)
{
    ImGuiWindow* window = GetCurrentWindowRead();
...
static float GetColumnWidthEx(ImGuiOldColumns* columns, int column_index, bool before_resize = false)
{
    ...
    return ImGui_Implementation::GetColumnOffsetFromNorm(columns, offset_norm);
}

float ImGui_Implementation::GetColumnWidth(int column_index)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    ImGuiOldColumns* columns = window->DC.CurrentColumns;
...
void ImGui_Implementation::SetColumnOffset(int column_index, float offset)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    ImGuiOldColumns* columns = window->DC.CurrentColumns;
...
void ImGui_Implementation::SetColumnWidth(int column_index, float width)
{
    ImGuiWindow* window = GetCurrentWindowRead();
    ImGuiOldColumns* columns = window->DC.CurrentColumns;
    IM_ASSERT(columns != NULL);
...
void ImGui_Implementation::PushColumnClipRect(int column_index)
{
    ImGuiWindow* window = GetCurrentWindowRead();
    ImGuiOldColumns* columns = window->DC.CurrentColumns;
    if (column_index < 0)
...
void ImGui_Implementation::PushColumnsBackground()
{
    ImGuiWindow* window = GetCurrentWindowRead();
    ImGuiOldColumns* columns = window->DC.CurrentColumns;
    if (columns->Count == 1)
...
void ImGui_Implementation::PopColumnsBackground()
{
    ImGuiWindow* window = GetCurrentWindowRead();
    ImGuiOldColumns* columns = window->DC.CurrentColumns;
    if (columns->Count == 1)
...
ImGuiOldColumns* ImGui_Implementation::FindOrCreateColumns(ImGuiWindow* window, ImGuiID id)
{
...
ImGuiID ImGui_Implementation::GetColumnsID(const char* str_id, int columns_count)
{
...
void ImGui_Implementation::BeginColumns(const char* str_id, int columns_count, ImGuiOldColumnFlags flags)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = GetCurrentWindow();
...
void ImGui_Implementation::NextColumn()
{
    ImGuiWindow* window = GetCurrentWindow();
...
void ImGui_Implementation::EndColumns()
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = GetCurrentWindow();
    ImGuiOldColumns* columns = window->DC.CurrentColumns;
...
void ImGui_Implementation::Columns(int columns_count, const char* id, bool borders)
{
    ImGuiWindow* window = GetCurrentWindow();
    IM_ASSERT(columns_count >= 1);
